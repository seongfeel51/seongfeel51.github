...
public class AutoCasting1 {
	...
	public static void main(String[] args) {
		...
		//이 때 작은 크기의 데이터는 큰 크기 타입으로 자동으로 타입이 변경
		...
		//char c2 = k1;		성격이 달라 캐스팅이 안됨
		int j1 = c1;		//서로 성격이 달라도 캐스팅이 되는 예외
		System.out.println("G1의 아스키코드번호 j1 : "+j1);
		
		double d2 = l1;		//정수 -> 실수(O)
		//long l4 = f;		//실수 -> 정수(X)
		
		float avg = (float) (100+70+80) / 3;	//강제캐스팅
